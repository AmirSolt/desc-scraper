...
INSERT INTO videos (
    ...
    description,
    channel_id
) VALUES ($1,$2,$3,$4) RETURNING id, created_at, yt_id, title, description, channel_id
`
...
SELECT id, created_at, yt_id, title, description, channel_id FROM videos WHERE yt_id = $1
`
...
SELECT id, created_at, yt_id, title, description, channel_id
FROM videos
